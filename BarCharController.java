...
public class BarCharController implements Initializable {
	@FXML
	private BarChart<String, Integer> income;
	@FXML
	private BarChart<String, Integer> outcome;

	@Override
	public void initialize(URL arg0, ResourceBundle arg1) { // 최근 1년간 분류별 barchart생성
