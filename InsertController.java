...
public class InsertController implements Initializable {
	...
	public void okHandler(ActionEvent event) throws Exception {
		try {
			...
			else if(type_data!=null&&category_data!=null&&!money_data.equals("")&&preparationDate_data!=null) {
				Account act = new Account(preparationDate_data,Integer.parseInt(money_data),type_data,category_data,0);
